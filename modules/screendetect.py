...
class Screendetect:
    #RGB value
    defeatedColor = (196,0,0)#Kırmızı
    playColor = (224, 186, 8)#Sarı
    loadColor = (0, 1, 0)#Siyah
    proceedColor = (35, 115, 255)#Koyu Mavi
    connection_lost_color = (66, 66, 66)#Gri
    starDropColor = (222, 72, 227)#Pembe
